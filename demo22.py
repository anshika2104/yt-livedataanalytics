...
def get_channeldetails(channel_id):
    ...
    #print (datanew)
    with open('C:\\Users\\ANSHIKA TANDON\\Downloads\\channnel details2.csv', 'w',encoding="utf-8",newline='') as csvfile:
...
def get_playlistId(channel_id):
    ...
    while extra_pages_is_there:
        ...
        #print(playlist)    
        with open('C:\\Users\\ANSHIKA TANDON\\Downloads\\playlistid_dips11.csv', 'w',encoding="utf-8",newline='') as csvfile:
...
def get_videodetails(playlist_id,videolist):
    ...
    file_exists = os.path.isfile('C:\\Users\\ANSHIKA TANDON\\Downloads\\aaa21.csv')
    ...
    with open('C:\\Users\\ANSHIKA TANDON\\Downloads\\aaa21.csv', 'a',encoding="utf-8",newline='') as csvfile:
            filewriter = csv.writer(csvfile, delimiter=',',quotechar='"', quoting=csv.QUOTE_MINIMAL)
            if not file_exists:
...
csv1 = pd.read_csv("C:\\Users\\ANSHIKA TANDON\\Downloads\\channnel details2.csv")
csv1.head()

csv2 = pd.read_csv("C:\\Users\\ANSHIKA TANDON\\Downloads\\playlistid_dips11.csv")
csv2.head()
...
df = merged_data.head()
df.to_csv("C:\\Users\\ANSHIKA TANDON\\Downloads\\firstleveljoin12.csv")

# ###############################end-combining-channel-playlist#########################################
###############################start-combining-channel-playlist-video#########################################
csv3 = pd.read_csv("C:/Users/ANSHIKA TANDON/Downloads\\firstleveljoin12.csv" )
csv3.head()
print(csv3)

csv4= pd.read_csv("C:/Users/ANSHIKA TANDON/Downloads/aaa21.csv")
csv4.head()

result = pd.merge(csv3, csv4, how="outer", on=["playlist_id"])
print(result)

result.to_csv("C:\\Users\\ANSHIKA TANDON\\Downloads\\secondleveljoin11.csv")
